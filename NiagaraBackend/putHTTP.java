...
public void onRefresh() throws Exception
{
  ...
  //inputs
  String  xml = putRequest(new URL(url.getValue().toString()), json.getValue().toString());
  out.setValue(xml);
  
}


public static String putRequest(final URL destination, String jsonData) throws IOException {
